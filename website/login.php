...
<?php
  ...
  {
    echo "<script>document.getElementById('loginEmail').innerHTML='Fck this';</script>";
    echo "<script>document.getElementById('loginPass').value='This sucks';</script>";
    //echo "<script>document.getElementById('loginBtn').click();</script>";
  }
  else
    echo $_SESSION['autologin']."First time in session.";
?>
<!DOCTYPE html>
<html>
<head>
